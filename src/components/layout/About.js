      ...
      <div>
        <div className="flex flex-col justify-around items-center gap-6 w-11/12 h-full mx-auto">
          <div className="flex flex-col justify-center items-center">
            <h3 className="text-2xl md:text-4xl lg:text-6xl font-bold md:font-extrabold text-center py-4">
              Discover the best food & <br></br>drinks in our Restaurant
            </h3>
            ...
            <a target="_blank" href="https://github.com/MOHDSAMIULLAH">
              <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 w-11/12">
            ...
            <div className="grid gap-4">
              ...
              <div>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/Images/about_vegNoodles.png"}
                  alt="Noodles"
                />
              </div>
              <div>
            ...
            <div className="grid gap-4">
              <div>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/Images/about_strawberry.png"}
            ...
            <div className="grid gap-4">
              ...
              <div>
                <img
                  className="h-auto max-w-full rounded-lg"
                  src={"/Images/about_watermelon.png"}
          ...
          <div class="w-full bg-white border-t border-b border-gray-200 px-5 py-16 md:py-24 text-gray-800">
            <div class="w-full max-w-6xl mx-auto">
              <div class="text-center max-w-xl mx-auto">
                <h3 class="text-6xl md:text-6xl font-bold mb-5 text-gray-600">
